public class Employee extends Person implements Calculatable,Relateable,Displayable{
	...
	Employee(String n , int a , int hpw , int sph , int yos){
	...
	public void display(){
		...
		System.out.println("Age is : " + super.getAge());
